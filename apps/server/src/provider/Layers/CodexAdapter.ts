          ...
          ...(mcpSession
            ? {
                environment: {
                  ...
                  AQQUA_MCP_BEARER_TOKEN: agentEnvironment?.AQQUA_AGENT_TOKEN,
                  ...agentEnvironment,
                },
                appServerArgs: [
                  "-c",
                  `mcp_servers.aqqua.url=${mcpSession.endpoint}`,
                  "-c",
                  'mcp_servers.aqqua.bearer_token_env_var="AQQUA_MCP_BEARER_TOKEN"',
                ],
              }
            : {}),
        };
