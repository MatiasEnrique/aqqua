import { tokenizeCliArgs } from "@aqqua/shared/cliArgs";

export const AQQUA_CODEX_LAUNCH_ARGS_ENV = "AQQUA_CODEX_LAUNCH_ARGS";

export const resolveCodexLaunchArgs = (
  launchArgs?: string,
  environment: NodeJS.ProcessEnv = process.env,
) => environment[AQQUA_CODEX_LAUNCH_ARGS_ENV]?.trim() || launchArgs?.trim() || "";
