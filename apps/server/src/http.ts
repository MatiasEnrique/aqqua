...
import { isDevProxiedPath } from "@aqqua/shared/devProxy";
import { decodeOtlpTraceRecords } from "@aqqua/shared/observability";
...
const DESKTOP_RENDERER_ORIGINS = ["aqqua://app", "aqqua-dev://app"];
...
export const browserApiCorsLayer = Layer.unwrap(
  Effect.gen(function* () {
    ...
    //
    // AQQUA_DEV_ALLOWED_ORIGINS covers dev servers reached from a second
