import { readConnectAuthorizeRequest } from "@aqqua/shared/connectAuth";
...
const TEST_ENV = {
  AQQUA_CLERK_PUBLISHABLE_KEY: "pk_test_Y2xlcmsuZXhhbXBsZS50ZXN0JA==",
  AQQUA_CLERK_CLI_OAUTH_CLIENT_ID: "oauth_client_test",
  AQQUA_HOSTED_APP_URL: "https://hosted.example.test",
};
