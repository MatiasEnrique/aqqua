...
>()("aqqua/project/ProjectFaviconResolver") {}
...
export const make = Effect.gen(function* () {
  ...
  const projectFileLoader = yield* AqquaProjectFileLoader.AqquaProjectFileLoader;
  ...
  const resolvePath: ProjectFaviconResolver["Service"]["resolvePath"] = Effect.fn(
    ...
    // An aqqua.json iconPath takes precedence over the well-known locations.
