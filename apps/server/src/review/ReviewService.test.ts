  ...
  it.effect("rejects diff preview cwd outside the configured workspace roots", () =>
    Effect.gen(function* () {
      ...
      const workspaceRoot = yield* fs.makeTempDirectoryScoped({
        prefix: "aqqua-review-workspace-",
      });
      const outsideRoot = yield* fs.makeTempDirectoryScoped({ prefix: "aqqua-review-outside-" });
      const baseDir = yield* fs.makeTempDirectoryScoped({ prefix: "aqqua-review-base-" });
