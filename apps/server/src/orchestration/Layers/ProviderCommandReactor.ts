...
import { isTemporaryWorktreeBranch, WORKTREE_BRANCH_PREFIX } from "@aqqua/shared/git";
...
const make = Effect.gen(function* () {
  ...
  const processTurnInterruptRequested = Effect.fn("processTurnInterruptRequested")(function* (
    ...
    // Failures must surface as an observable activity so board sagas can fail the
    // durable card operation instead of silently continuing into archive/cleanup.
