  ...
  const checkpoints: VcsDriver.VcsCheckpointOps = {
    captureCheckpoint: Effect.fn("GitVcsDriver.checkpoints.captureCheckpoint")(function* (input) {
      ...
      const tempIndexPath = path.join(
        gitCommonDir,
        `aqqua-checkpoint-index-${NodeCrypto.randomUUID()}`,
      );
      const commitEnv: NodeJS.ProcessEnv = {
        ...process.env,
        GIT_INDEX_FILE: tempIndexPath,
        GIT_AUTHOR_NAME: "aqqua",
        GIT_AUTHOR_EMAIL: "aqqua@users.noreply.github.com",
        GIT_COMMITTER_NAME: "aqqua",
        GIT_COMMITTER_EMAIL: "aqqua@users.noreply.github.com",
      };
      ...
      yield* Effect.gen(function* () {
        ...
        const message = `aqqua checkpoint ref=${input.checkpointRef}`;
