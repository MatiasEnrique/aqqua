...
export const RPC_REQUIRED_SCOPES = {
  ...
  [WS_METHODS.providerListSessions]: AuthOrchestrationReadScope,
  [WS_METHODS.providerReadSession]: AuthOrchestrationReadScope,
  ...
  [WS_METHODS.usageGetOverview]: AuthOrchestrationReadScope,
  [WS_METHODS.usageGetBreakdown]: AuthOrchestrationReadScope,
  [WS_METHODS.usageRefreshScan]: AuthOrchestrationOperateScope,
  [WS_METHODS.usageClearLedger]: AuthOrchestrationOperateScope,
  [WS_METHODS.vcsRefreshStatus]: AuthOrchestrationReadScope,
  [WS_METHODS.vcsPull]: AuthOrchestrationOperateScope,
  [WS_METHODS.gitRunStackedAction]: AuthOrchestrationOperateScope,
  [WS_METHODS.gitResolvePullRequest]: AuthOrchestrationOperateScope,
  [WS_METHODS.gitGetChangeRequestChecks]: AuthOrchestrationReadScope,
  [WS_METHODS.gitGetChangeRequestConversation]: AuthOrchestrationReadScope,
  [WS_METHODS.gitAddChangeRequestComment]: AuthOrchestrationOperateScope,
