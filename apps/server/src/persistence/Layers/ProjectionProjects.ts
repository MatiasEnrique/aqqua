...
import { ModelSelection, ProjectIcon, ProjectScript } from "@aqqua/contracts";
    ...
    execute: (row) =>
      sql`
        ...
        DO UPDATE SET
          ...
          new_worktrees_origin_branch = excluded.new_worktrees_origin_branch,
