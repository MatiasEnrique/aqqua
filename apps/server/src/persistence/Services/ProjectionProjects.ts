 ...
 */
import { IsoDateTime, ModelSelection, ProjectId, ProjectScript } from "@aqqua/contracts";
...
>()("aqqua/persistence/Services/ProjectionProjects/ProjectionProjectRepository") {}
