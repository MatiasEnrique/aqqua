# aqqua Mobile Terminal Native Module
...
fork, with aqqua's iOS 16 compatibility patch applied. `AqquaTerminalView` owns a `libghostty` surface and
...
```bash
apps/mobile/modules/aqqua-terminal/scripts/build-libghostty-ios16.sh
```
...
```bash
apps/mobile/modules/aqqua-terminal/scripts/build-libghostty-android.sh
```
