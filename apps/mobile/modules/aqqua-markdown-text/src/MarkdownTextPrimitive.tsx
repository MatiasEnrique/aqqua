...
import AqquaMarkdownTextRunNativeComponent from "./AqquaMarkdownTextRunNativeComponent";
import AqquaMarkdownTextNativeComponent from "./AqquaMarkdownTextNativeComponent";
...
function MarkdownTextPrimitiveChild({ style, children, ...rest }: MarkdownTextPrimitiveProps) {
  ...
  const nativeChildren = React.Children.toArray(children).map((child) => {
    ...
    return (
      ...
      <AqquaMarkdownTextRunNativeComponent
  ...
  if (!isAncestor) {
    return (
      <TextAncestorContext.Provider value={contextValue}>
        <AqquaMarkdownTextNativeComponent
          {...textDefaults}
          {...rest}
