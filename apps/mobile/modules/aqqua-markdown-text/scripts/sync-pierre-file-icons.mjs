...
const customSprite = webIconSource.match(/const AQQUA_FILE_ICON_SPRITE = `([\s\S]*?)`;/)?.[1];

if (!customSprite) {
  throw new Error("Could not read the aqqua Pierre icon sprite from apps/web/src/pierre-icons.ts");
}
...
const customIcons = {
  agents: "aqqua-file-icon-agents",
  claude: "aqqua-file-icon-claude",
  package: "aqqua-file-icon-package-json",
  pnpm: "aqqua-file-icon-pnpm",
  readme: "aqqua-file-icon-readme",
  tsconfig: "aqqua-file-icon-tsconfig",
};
