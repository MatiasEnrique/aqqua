...
import { AqquaKeyboardCommands } from "../../native/AqquaKeyboardCommands";
import {
...
export function HardwareKeyboardCommandProvider({
  ...
  return (
    <AqquaKeyboardCommands enabledCommands={enabledCommands} onCommand={onCommand}>
      {children}
    </AqquaKeyboardCommands>
  );
}
