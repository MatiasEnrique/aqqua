...
const SHOWCASE_LOCAL_ENVIRONMENT_DISPLAY_URLS: Readonly<Record<string, string>> = {
  ...
  "Suspense Station": "https://suspense-vps.hel1.aqqua.sh/",
...
const pocketPiEndpoint = {
  httpBaseUrl: "https://pocket-pi.aqqua.sh",
  wsBaseUrl: "wss://pocket-pi.aqqua.sh",
  providerKind: "aqqua_relay" as const,
};
...
export const SHOWCASE_CONNECTED_CLOUD_ENVIRONMENTS: ReadonlyArray<ConnectedEnvironmentSummary> = [
  {
    ...
    displayUrl: "https://aurora-gpu.aqqua.sh",
    isRelayManaged: true,
