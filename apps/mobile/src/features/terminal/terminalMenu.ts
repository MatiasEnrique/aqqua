import { type KnownTerminalSession } from "@aqqua/client-runtime/state/terminal";
import { DEFAULT_TERMINAL_ID, type ProjectScript } from "@aqqua/contracts";
...
} from "@aqqua/shared/terminalLabels";
