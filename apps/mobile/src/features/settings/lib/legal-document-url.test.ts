...
describe("isLegalDocumentUrl", () => {
  it.each([
    "https://aqqua.codes/legal",
    "https://aqqua.codes/legal/",
    "https://aqqua.codes/privacy-policy?source=app",
    "https://aqqua.codes/terms-of-service#updates",
    "https://aqqua.codes/security-policy",
  ])("allows a configured legal document: %s", (url) => {
    expect(isLegalDocumentUrl(url)).toBe(true);
  });

  it.each([
    "https://aqqua.codes/download",
