...
const CONNECTIONS_KEY = "aqqua.connections";
const AGENT_AWARENESS_DEVICE_ID_KEY = "aqqua.agent-awareness.device-id";
const AGENT_AWARENESS_REGISTRATION_KEY = "aqqua.agent-awareness.registration";
const RECENT_THREAD_SHORTCUTS_KEY = "aqqua.recent-thread-shortcuts";
...
>()("@aqqua/mobile/persistence/MobileStorage") {}
