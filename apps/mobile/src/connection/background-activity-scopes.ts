import type { EnvironmentRpcSubscriptionObservation } from "@aqqua/client-runtime/rpc";
import { type BackgroundScope, type EnvironmentId, WS_METHODS } from "@aqqua/contracts";
