import { PRIMARY_LOCAL_ENVIRONMENT_ID } from "@aqqua/contracts";
import { makeLocalFileTracer, makeTraceSink } from "@aqqua/shared/observability";
...
>()("@aqqua/desktop/app/DesktopObservability/DesktopBackendOutputLogFactory") {}
