import type { DesktopSshPasswordPromptRequest } from "@aqqua/contracts";
import { DesktopSshPasswordPromptResolutionInputSchema } from "@aqqua/contracts";
import type { SshPasswordRequest } from "@aqqua/ssh/auth";
...
export class DesktopSshPromptWindowUnavailableError extends Schema.TaggedErrorClass<DesktopSshPromptWindowUnavailableError>()(
  ...
  override get message(): string {
    ...
    return `aqqua window is unavailable during ${this.stage} for SSH authentication to ${this.destination} (request: ${request}).`;
  }
}
...
>()("@aqqua/desktop/ssh/DesktopSshPasswordPrompts") {}
