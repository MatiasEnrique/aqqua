...
>()("@aqqua/desktop/shell/DesktopShellEnvironment") {}
...
const startMarker = (name: string) => `__AQQUA_ENV_${name}_START__`;
const endMarker = (name: string) => `__AQQUA_ENV_${name}_END__`;
