...
import { resolveRemoteAqquaCliPackageSpec } from "@aqqua/ssh/command";
import type { RemoteAqquaRunnerOptions } from "@aqqua/ssh/tunnel";
...
const resolveDesktopSshCliRunner = (
...
): RemoteAqquaRunnerOptions => {
  const devRemoteEntryPath = Option.getOrUndefined(environment.devRemoteAqquaServerEntryPath);
  ...
  return {
    packageSpec: resolveRemoteAqquaCliPackageSpec({
