...
import { waitForHttpReady as waitForHttpReadyShared } from "@aqqua/shared/httpReadiness";
...
const BACKEND_READINESS_PATH = "/.well-known/aqqua/environment";
...
export interface DesktopBackendStartConfig extends BackendProcessContext {
  ...
  // AQQUA_HOME can't pin the WSL backend to /mnt/c/...\.aqqua.
