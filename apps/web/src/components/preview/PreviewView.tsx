...
import { scopedThreadKey } from "@aqqua/client-runtime/environment";
...
import { normalizePreviewUrl } from "@aqqua/shared/preview";
  ...
  return (
    ...
    >
      ...
      <div className="relative min-h-0 flex-1 overflow-hidden">
        ...
        {controller !== "none" ? (
          <div className="pointer-events-none absolute left-3 top-3 z-40 rounded-md border border-border/70 bg-background/90 px-2.5 py-1 text-[11px] font-medium shadow-sm backdrop-blur">
