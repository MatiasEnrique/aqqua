import { CheckpointRef, EnvironmentId, MessageId, TurnId } from "@aqqua/contracts";
        ...
        timelineEntries={[
          {
            ...
            entry: {
              ...
              label: "Updated files",
              tone: "tool",
              changedFiles: ["C:/Users/mike/dev-stuff/aqqua/apps/web/src/session-logic.ts"],
            },
          },
        ]}
        workspaceRoot="C:/Users/mike/dev-stuff/aqqua"
      />,
    );

    expect(markup).toContain("aqqua/apps/web/src/session-logic.ts");
    expect(markup).not.toContain("C:/Users/mike/dev-stuff/aqqua/apps/web/src/session-logic.ts");
  });
