...
export const ComposerStashBadge = memo(function ComposerStashBadge(props: {
  ...
  return (
    <button
      ...
      className={cn(
        "absolute -top-3 right-4 z-10 inline-flex cursor-pointer items-center gap-1.5 rounded-md border bg-popover px-2.5 py-0.5 text-xs shadow-sm",
    ...
    >
      ...
      <span
        key={props.pulseKey}
        className={cn(
          "rounded-sm px-1.5 text-[10px] font-medium tabular-nums",
          props.pulsing
