  ...
  useEffect(() => {
    const onWindowKeyDown = (event: KeyboardEvent) => {
      ...
      if (command === "chat.new") {
        event.preventDefault();
        event.stopPropagation();
        // Both conversation sidebars route creation through the command
        // palette whenever there is a real project choice to make.
        ...
        if (!isPreviewSupportedInRuntime()) {
          toastManager.add(
            stackedThreadToast({
              ...
              description: "Open 3T Code in the desktop app to use the in-app preview.",
            }),
          );
          return;
        }
