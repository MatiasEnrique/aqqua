...
const PIERRE_ICON_SPRITE_ID = "aqqua-pierre-file-icon-sprite";

const AQQUA_FILE_ICON_SPRITE = `
<svg xmlns="http://www.w3.org/2000/svg" width="0" height="0" aria-hidden="true">
  <symbol id="aqqua-file-icon-package-json" viewBox="0 0 32 32">
    <path d="M2 2H30V30H2" fill="#c12127" />
    <path d="M7.25 7.25h17.5v17.5h-3.5v-14H16v14H7.25" fill="#fff" />
  </symbol>
  <symbol id="aqqua-file-icon-tsconfig" viewBox="0 0 32 32">
  ...
  <symbol id="aqqua-file-icon-agents" viewBox="0 0 32 32">
  ...
  <symbol id="aqqua-file-icon-claude" viewBox="0 0 32 32">
  ...
  <symbol id="aqqua-file-icon-readme" viewBox="0 0 32 32">
  ...
  <symbol id="aqqua-file-icon-pnpm" viewBox="0 0 32 32">
...
export const AQQUA_PIERRE_ICONS = {
  set: "complete",
  colored: true,
  spriteSheet: AQQUA_FILE_ICON_SPRITE,
  byFileName: {
    "package.json": "aqqua-file-icon-package-json",
    "tsconfig.json": "aqqua-file-icon-tsconfig",
    "agents.md": "aqqua-file-icon-agents",
    "claude.md": "aqqua-file-icon-claude",
    "readme.md": "aqqua-file-icon-readme",
    "pnpm-lock.yaml": "aqqua-file-icon-pnpm",
    "pnpm-workspace.yaml": "aqqua-file-icon-pnpm",
  },
} satisfies FileTreeIcons;

const completeIconResolver = createFileTreeIconResolver(AQQUA_PIERRE_ICONS);
...
export function ensurePierreIconSprite(): void {
  ...
  container.innerHTML = `${getBuiltInSpriteSheet("complete")}${AQQUA_FILE_ICON_SPRITE}`;
