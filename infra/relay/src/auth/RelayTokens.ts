...
import { encodeOAuthScope, parseAllowedOAuthScope } from "@aqqua/shared/oauthScope";
import {
...
const LINK_CHALLENGE_TYP = "aqqua-link-challenge+jwt";
const ACCESS_TOKEN_TYP = "aqqua-relay-dpop-access+jwt";
