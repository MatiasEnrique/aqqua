...
const rule = createOxlintRuleHarness("aqqua/no-manual-effect-runtime-in-tests", {
  filename: "fixture.test.ts",
});

describe("aqqua/no-manual-effect-runtime-in-tests", () => {
  rule.valid(
...
const productionRule = createOxlintRuleHarness("aqqua/no-manual-effect-runtime-in-tests");
