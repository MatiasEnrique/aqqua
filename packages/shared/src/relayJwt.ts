...
export const RELAY_LINK_PROOF_TYP = "aqqua-env-link+jwt";
export const RELAY_MINT_REQUEST_TYP = "aqqua-cloud-mint+jwt";
export const RELAY_HEALTH_REQUEST_TYP = "aqqua-cloud-health+jwt";
export const RELAY_MINT_RESPONSE_TYP = "aqqua-env-mint+jwt";
export const RELAY_HEALTH_RESPONSE_TYP = "aqqua-env-health+jwt";
export const RELAY_ACTIVITY_PUBLISH_TYP = "aqqua-env-activity+jwt";
