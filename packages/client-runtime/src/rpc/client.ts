import { ORCHESTRATION_WS_METHODS, WS_METHODS } from "@aqqua/contracts";
...
}>("@aqqua/client-runtime/rpc/EnvironmentRpcRequestObserver", {
  defaultValue: () => ({
...
export type EnvironmentSubscriptionRpcTag =
  ...
  | typeof WS_METHODS.subscribeAccountUsage
...
}>("@aqqua/client-runtime/rpc/EnvironmentRpcSubscriptionObserver", {
  defaultValue: () => ({
    observe: () => Effect.succeed(Effect.void),
  }),
}) {}
