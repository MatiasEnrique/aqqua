...
import { RelayManagedEndpoint } from "@aqqua/contracts/relay";
...
export class RemoteDpopAccessToken extends Schema.Class<RemoteDpopAccessToken>(
  "@aqqua/client-runtime/authorization/RemoteDpopAccessToken",
)({
...
>()("@aqqua/client-runtime/authorization/tokenStore/RemoteDpopAccessTokenStore") {}
