import type { DesktopSshEnvironmentTarget, EnvironmentId } from "@aqqua/contracts";
import { resolveRemotePairingTarget } from "@aqqua/shared/remote";
...
>()("@aqqua/client-runtime/connection/onboarding/ConnectionOnboarding") {}
