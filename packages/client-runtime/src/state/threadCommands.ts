...
import {
  ...
  type DequeueThreadMessageInput,
  ...
  type SubmitThreadMessagesInput,
...
export type {
  ...
  CreateThreadInput,
  DeleteThreadInput,
  DequeueThreadMessageInput,
  EnqueueThreadMessageInput,
...
export function createThreadEnvironmentAtoms<R, E>(
  ...
  return {
    ...
    dequeueMessage: createEnvironmentCommand(runtime, {
      label: "environment-data:commands:thread:dequeue-message",
      execute: (input: DequeueThreadMessageInput) => dequeueThreadMessage(input),
      scheduler,
      concurrency,
    }),
    submitMessages: createEnvironmentCommand(runtime, {
      label: "environment-data:commands:thread:submit-messages",
      execute: (input: SubmitThreadMessagesInput) => submitThreadMessages(input),
      scheduler,
      concurrency,
    }),
