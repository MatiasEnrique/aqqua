...
import { AqquaProjectFile } from "./aqquaProjectFile.ts";

const decode = Schema.decodeUnknownSync(AqquaProjectFile);

describe("AqquaProjectFile", () => {
  it("decodes a full project file", () => {
    const decoded = decode({
      $schema: "https://aqqua.codes/schema/aqqua.json",
