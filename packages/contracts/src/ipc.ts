...
export type DesktopAppStageLabel = "Alpha" | "Dev" | "Sigma";
...
export const DesktopAppStageLabelSchema = Schema.Literals(["Alpha", "Dev", "Sigma"]);
...
export interface DesktopPreviewWebviewConfig {
  /** `persist:aqqua-preview` (or whatever the desktop chose). */
  partition: string;
  /**
...
export interface DesktopBridge {
  ...
  setAgentAwake: (active: boolean) => Promise<void>;
