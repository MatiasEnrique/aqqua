...
import { HostProcessEnvironment } from "@aqqua/shared/hostProcess";
...
const ICON_VARIANTS = [
  ...
  {
    label: "preview",
    source: BRAND_ASSET_PATHS.previewIconComposerProject,
    outputs: {
      ios: BRAND_ASSET_PATHS.previewIosIconPng,
      macos: BRAND_ASSET_PATHS.previewMacIconPng,
      universal: BRAND_ASSET_PATHS.previewUniversalIconPng,
